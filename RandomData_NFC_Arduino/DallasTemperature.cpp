...
int16_t DallasTemperature::getMSBTemp() {
  ScratchPad scratchPad;
  return scratchPad[TEMP_MSB];
}

int16_t DallasTemperature::getLSBTemp() {
  ScratchPad scratchPad;
  return scratchPad[TEMP_LSB];
}
...
//  String s1 = String(scratchPad[TEMP_MSB]);
//  String s2 = String(scratchPad[TEMP_LSB]);
  /*
