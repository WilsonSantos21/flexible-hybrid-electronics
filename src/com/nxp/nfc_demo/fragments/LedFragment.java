...
public class LedFragment extends Fragment { //implements OnClickListener {
	...
	private static TextView textTempSens;
...
//		ntagLogo = (ImageView) layout.findViewById(R.id.trafficlight);
		...
		textTempSens = (TextView) layout.findViewById(R.id.TempSensText);
...
/*	public static void setButton(byte Bit_field) {
	...
	public static double getArduino() {
		return arduino;
	}
	...
	public static void setTempSens(String answer) {
		textTempSens.setText(answer);
	}
